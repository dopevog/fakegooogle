...
function run() {
	...
	let phdrs = ["Search something!", "Type anything here to search!", "Try clicking the info button on search results!", "Made by Vedant!", "Do you like the search engine?", "Unlike other search engines this doesn't track you!", "You can share links to searches!"]
	setInterval(() => {
